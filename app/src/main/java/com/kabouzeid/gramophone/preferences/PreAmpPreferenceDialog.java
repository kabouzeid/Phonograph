...
public class PreAmpPreferenceDialog extends DialogFragment implements SeekBar.OnSeekBarChangeListener {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    withRgValue = PreferenceUtil.getInstance(getContext()).getRgPreampWithTag();
    withoutRgValue = PreferenceUtil.getInstance(getContext()).getRgPreampWithoutTag();
  ...
  private void updateAndClose() {
    PreferenceUtil.getInstance(getContext()).setReplayGainPreamp(withRgValue, withoutRgValue);
    dismiss();
  }
